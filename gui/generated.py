...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Chow Chow", pos = wx.DefaultPosition, size = wx.Size( 400,150 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
