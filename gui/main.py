...
class MainFrame(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Chow Chow", pos=wx.DefaultPosition,
                          size=wx.Size(400, 120), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        ...
        self.m_staticText1 = wx.StaticText(self.panel, wx.ID_ANY, u"Insert your task:", wx.DefaultPosition,
                                           wx.DefaultSize, 0)
        self.m_staticText1.Wrap(-1)
        controls_fg_sizer.Add(self.m_staticText1, 0, wx.ALL, 5)

        cmb_taskChoices = [u"Breakfast", u"Lunch"]
        self.cmb_task = PromptingComboBox(self.panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                          cmb_taskChoices, 0)
